  ...
  cases: [
    {
      ...
      fase_atual: 'diagnose', status: 'active', produto: 'Plataforma',
      valor_contrato: 45000, data_inicio: '2026-04-01', prazo_dias: 60,
      dias_decorridos: 42, progresso: 70,
      ...
      phases: {
        ...
        diagnose:  { status: 'active',    data_inicio: '2026-04-13', data_fim: null,         prazo: 20, real: null },
        design:    { status: 'pending',   data_inicio: null,         data_fim: null,         prazo: 15, real: null },
        decide:    { status: 'pending',   data_inicio: null,         data_fim: null,         prazo: 10, real: null },
        deliver:   { status: 'pending',   data_inicio: null,         data_fim: null,         prazo: 5,  real: null },
      },
      artifacts: [
        ...
        { id: 'T05', nome: 'Validação Causa Raiz',       fase: 'diagnose',  status: 'in_progress' },
        { id: 'T06', nome: 'Canvas de Alternativas',     fase: 'design',    status: 'pending' },
        { id: 'T07', nome: 'Valor × Complexidade + WSJF',fase: 'decide',    status: 'pending' },
        { id: 'T08', nome: '5W2H + Riscos + KPIs',       fase: 'decide',    status: 'pending' },
        { id: 'T09', nome: 'Montagem do A3 Expandido',   fase: 'deliver',   status: 'pending' },
      ],
      data_requests: [
